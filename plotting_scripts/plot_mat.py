...
plot_drift.plot_all_data(bins[0:11], lines[0:45001], pixel_size, timestep, title, output)

plot_drift.plot_x_histogram(bins[0:11], pixel_size, title, output)

plot_drift.plot_y_histogram(bins[0:11], pixel_size, title, output)

## Mean

plot_drift.mean_and_std(bins[0:11], pixel_size, title, output)
